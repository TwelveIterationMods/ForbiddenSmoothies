...
public class BlenderBlockEntity extends BalmBlockEntity implements BalmMenuProvider, BalmContainerProvider, BalmEnergyStorageProvider {
    ...
    protected final ContainerData dataAccess = new ContainerData() {
        public int get(int i) {
            return switch (i) {
                case DATA_PROGRESS -> BlenderBlockEntity.this.printingProgress;
                case DATA_MAX_PROGRESS -> BlenderBlockEntity.this.printingTotalTime;
                ...
                case DATA_ENERGY_TOTAL -> BlenderBlockEntity.this.energyStorage.getCapacity();
        ...
        public void set(int i, int value) {
            switch (i) {
                case DATA_PROGRESS -> BlenderBlockEntity.this.printingProgress = value;
                case DATA_MAX_PROGRESS -> BlenderBlockEntity.this.printingTotalTime = value;
