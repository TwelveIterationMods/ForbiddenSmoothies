...
public class JeiPrinterRecipeCategory implements IRecipeCategory<PrinterRecipe> {
    ...
    public static final RecipeType<PrinterRecipe> TYPE = RecipeType.create(ForbiddenSmoothies.MOD_ID, "printer", PrinterRecipe.class);
    ...
    public JeiPrinterRecipeCategory(IGuiHelper guiHelper) {
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.printer));
    ...
    public Component getTitle() {
        return Component.translatable("jei.forbiddensmoothies.printer");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, PrinterRecipe recipe, IFocusGroup focuses) {
